...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Web Designer", "UI/UX Designer","Software Developer" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Eric`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Software Designer", "UI/UX Designer" ,"Ethical Hacker"]'><span className="wrap">{text}</span></span></h1>
